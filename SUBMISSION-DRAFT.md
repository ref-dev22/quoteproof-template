...
**Submission status:** [PR #1](https://github.com/ref-dev22/quoteproof-template/pull/1) has merged into public `main`. The `f253f1a` implementation/navigation revision passed [CI](https://github.com/ref-dev22/quoteproof-template/actions/runs/35898448985) and the [external scaffold/runtime gate](https://github.com/ref-dev22/quoteproof-template/actions/runs/35898464171). Check [main Actions](https://github.com/ref-dev22/quoteproof-template/actions?query=branch%3Amain) for the later video/documentation revision. This is a reviewer packet; the competition form has not been submitted.
...
- [Existing production app](https://quoteproof.vercel.app/) and its earlier 118-second recording remain on the older `985f15f` baseline; no production promotion occurred.
- [Isolated public judge preview](https://quoteproof-judge-preview.vercel.app/?tx=0x076690438e81f96fc77f3f6467157d2f53c05703ef098790a42b82909a340ef9) is rebuilt from checked `f253f1a` public implementation and remains separate from original production. Its [updated 99.44-second silent, captioned walkthrough](https://quoteproof-judge-preview.vercel.app/demo/index.html) captures the current app's read-only journey, then displays the clearly labeled historical four-case standalone report.
...
The `f253f1a` implementation/navigation revision passed [main CI](https://github.com/ref-dev22/quoteproof-template/actions/runs/35898448985) and an [empty-directory external scaffold](https://github.com/ref-dev22/quoteproof-template/actions/runs/35898464171) on Node 20.18.3 with CLI 0.4.0. The latter checked source provenance, `npm ci`, compile, 38 tests, types, zero-warning lint, production build/start, workshop and six HTTP/API checks. A clean archive of that implementation built in the separate public judge project; the real browser capture showed Connect Wallet, current source link, live reference, genuine historical three-way match and actual receipt export. A later video/documentation revision needs its own checks.
