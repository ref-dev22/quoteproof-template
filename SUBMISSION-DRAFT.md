...
**Draft status:** [PR #1](https://github.com/ref-dev22/quoteproof-template/pull/1) is under review. The preceding verified draft head is `94435e1`; check the PR and Actions for the current head. Public `main` is still `3092716`. This document is a reviewer packet, not a claim that the competition form has been submitted.
...
- [Isolated public judge preview](https://quoteproof-judge-preview.vercel.app/?tx=0x076690438e81f96fc77f3f6467157d2f53c05703ef098790a42b82909a340ef9) from `94435e1` passed six unauthenticated hosted HTTP/API checks and the read-only historical comparison. Check the [PR body](https://github.com/ref-dev22/quoteproof-template/pull/1) for the exact deployed commit after updates.
