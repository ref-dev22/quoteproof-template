...
export const metadata = getMetadata({
  title: "QuoteProof — Hedera reference receipts",
  description: "Inspect and independently verify a Chainlink-backed HBAR/USD reference quote before a wallet write.",
});
